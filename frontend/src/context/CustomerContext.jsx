...
export const CustomerProvider = ({ children }) => {
    ...
    const Customer = async (nitProvider) => {
        ...
        const response = await fetch(`http://localhost:8000/api/v1/customer/?nit_provider=${nitProvider}`)
    ...
    const createCustomer = async (nit, name, last_name, phone, email, nit_provider) => {
        ...
        const response = await fetch("http://127.0.0.1:8000/api/v1/create_customer/", {
            method: "POST",
            headers: {
    ...
    const updateCustomer = async (id, formData) => {
        try {
            const response = await fetch(`http://127.0.0.1:8000/api/v1/customer/${id}/update/`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json"
                },
    ...
    const deleteCustomer = async (id) => {
        try {
            const response = await fetch(`http://127.0.0.1:8000/api/v1/customer/${id}/delete/`, {
                method: "DELETE",
            })
    ...
    const Financial = async (nitProvider) => {
        ...
        const response = await fetch(`http://localhost:8000/api/v1/financials/?nit_provider=${nitProvider}`)
    ...
    const createFinancial = async (customer, borrowed, credit, fee, nit_provider) => {
        ...
        const response = await fetch("http://127.0.0.1:8000/api/v1/create_financial/", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const deleteFinancial = async (id) => {
        try {
            const response = await fetch(`http://127.0.0.1:8000/api/v1/financials/${id}/delete/`, {
                method: "DELETE",
            })
    ...
    const createFee = async (financial_id, paid, date) => {
        console.log("test")
        const response = await fetch(`http://127.0.0.1:8000/api/v1/create_fee/`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
